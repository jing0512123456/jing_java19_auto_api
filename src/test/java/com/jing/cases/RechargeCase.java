...
public class RechargeCase extends BaseCase {
    ...
    public void test(CaseInfo caseInfo){
        ...
        //2.数据库前置查询结果
        Object beforeAssertResult = SqlUtils.getScalarHandler(caseInfo.getSql());
        //2.1获取带token的请求头
        ...
        //6.数据库后置查询结果
        Object afterAssertResult = SqlUtils.getScalarHandler(caseInfo.getSql());
        //7.数据库断言
        Boolean sqlAssertflag = sqlAssert(caseInfo, beforeAssertResult, afterAssertResult);
        //8.添加断言回写内容
